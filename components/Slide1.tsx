  ...
  useEffect(() => {
    if (window.parent) {
      window.parent.postMessage({
        ...
        slideIndex: 1 // Use 1-based index for navigation
      }, '*');
    }
  }, []);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">Interactive Course - Teaching Kids Music</p>
          </div>
      ...
      <div className="text-center py-12">
        <TextBrick variant="h1" className="mb-6">Introduction to Music Education</TextBrick>
        <EmptyBrick id="slide-1-title-below" />
        <TextBrick className="text-lg mb-8">
          Welcome to Teaching Kids Music! This slide is part of your interactive course.
        </TextBrick>
        <EmptyBrick id="slide-1-content-1" />
        <div className="space-y-4">
          <div className="bg-gray-50 p-6 rounded-lg">
            <TextBrick variant="h3" className="text-lg font-medium text-gray-800 mb-2">Add your content here</TextBrick>
            <EmptyBrick id="slide-1-content-2" />
          ...
          <EmptyBrick id="slide-1-content-3" />
        </div>
      </div>
